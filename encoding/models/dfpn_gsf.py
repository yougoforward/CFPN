...
class dfpn_gsfHead(nn.Module):
    def __init__(self, in_channels, out_channels, norm_layer, se_loss, jpu=False, up_kwargs=None,
        ...
        self.project_pam = nn.Sequential(nn.Conv2d(inter_channels, inter_channels, 1, padding=0, dilation=1, bias=False),
    ...
    def forward(self, c0,c1,c2,c3,c4):
        ...
        pam = self.pam(self.project_pam(out2))
        out = self.project(torch.cat([p2_1,p2_8,p3_1,p3_8,p4_1,p4_8,pam], dim=1))
