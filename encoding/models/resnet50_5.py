...
from ..dilated import resnet5 as resnet

__all__ = ['resnet50_5', 'get_resnet50_5']
...
class resnet50_5(nn.Module):
    def __init__(self, nclass, backbone, aux=True, se_loss=False, norm_layer=nn.BatchNorm2d, base_size=520, crop_size=480, mean=[.485, .456, .406],
        ...
        self.base = resnet.resnet50_5(pretrained=False, norm_layer=norm_layer)
...
def get_resnet50_5(dataset='pascal_voc', backbone='resnet50_5', pretrained=False,
                 root='~/.encoding/models', **kwargs):
    # infer number of classes
    from ..datasets import datasets
    model = resnet50_5(datasets[dataset.lower()].NUM_CLASS, backbone=backbone, root=root, **kwargs)
    if pretrained:
