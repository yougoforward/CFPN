...
class dfpn8_gsfHead(nn.Module):
    def __init__(self, in_channels, out_channels, norm_layer, se_loss, jpu=False, up_kwargs=None,
        ...
        self.context4 = Context2(in_channels, inter_channels, inter_channels, 3, norm_layer)
        ...
        #                            nn.ReLU(),
        #                            )
        self.project = nn.Sequential(nn.Conv2d(12*inter_channels, inter_channels, 1, padding=0, dilation=1, bias=False),
                                   norm_layer(inter_channels),
                                   nn.ReLU(),
                                   )
