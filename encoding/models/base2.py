...
class BaseNet(nn.Module):
    def __init__(self, nclass, backbone, aux, se_loss, jpu=True, dilated=False, norm_layer=None,
        ...
        self.gff1 = PAM_Module(in_dim=512, key_dim=512//8,value_dim=512,out_dim=512,norm_layer=norm_layer)
        self.gff2 = PAM_Module(in_dim=1024, key_dim=1024//8,value_dim=1024,out_dim=1024,norm_layer=norm_layer)
