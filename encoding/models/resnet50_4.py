...
from ..dilated import resnet4 as resnet

__all__ = ['resnet50_4', 'get_resnet50_4']
...
def get_resnet50_4(dataset='pascal_voc', backbone='resnet50_4', pretrained=False,
                 root='~/.encoding/models', **kwargs):
    # infer number of classes
    from ..datasets import datasets
    model = resnet50_4(datasets[dataset.lower()].NUM_CLASS, backbone=backbone, root=root, **kwargs)
    if pretrained:
