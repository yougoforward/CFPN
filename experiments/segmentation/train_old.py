...
class Trainer():
    def __init__(self, args):
        ...
        if args.resume is not None:
            ...
            #     print(k)
            if args.ignore_last_layer:
                state_dict.pop('head.conv6.1.weight')
                state_dict.pop('head.conv6.1.bias')
                state_dict.pop('auxlayer.conv5.4.weight')
                state_dict.pop('auxlayer.conv5.4.bias')
            if args.cuda:
...
if __name__ == "__main__":
    ...
    for epoch in range(trainer.args.start_epoch, trainer.args.epochs):
        ...
        if not trainer.args.no_val:
            if epoch%10==0 or epoch > trainer.args.epochs-6:
