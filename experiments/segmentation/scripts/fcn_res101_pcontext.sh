...
#     --model fcn --aux --base-size 520 --crop-size 520 \
...
# python -m experiments.segmentation.test_whole --dataset pcontext \
#     --model fcn --aux --base-size 520 --crop-size 520 \
#     --backbone resnet101 --resume experiments/segmentation/runs/pcontext/fcn/fcn_res101_pcontext/model_best.pth.tar --split val --mode test --ms

python -m experiments.segmentation.test_whole --dataset pcontext \
    --model fcn --aux --base-size 520 --crop-size 520 \
    --backbone resnet101 --resume experiments/segmentation/runs/pcontext/fcn/fcn_res101_pcontext/model_best.pth.tar --split val --mode test