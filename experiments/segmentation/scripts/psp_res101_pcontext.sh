...
# python -m experiments.segmentation.test_whole --dataset pcontext \
#     --model psp --aux --dilated --base-size 520 --crop-size 520 \
#     --backbone resnet101 --resume experiments/segmentation/runs/pcontext/psp/psp_res101_pcontext/model_best.pth.tar --split val --mode test --ms

python -m experiments.segmentation.test_whole --dataset pcontext \
    --model psp --aux --dilated --base-size 520 --crop-size 520 \
    --backbone resnet101 --resume experiments/segmentation/runs/pcontext/psp/psp_res101_pcontext/model_best.pth.tar --split val --mode test